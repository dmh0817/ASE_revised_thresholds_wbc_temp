...
# ================================================================
```{r}
temp_lower_histogram <- crossings_temp$bin_mid[1]
temp_upper_histogram <- crossings_temp$bin_mid[2]
```
...
# ================================================================
```{r}
wbc_lower_histogram <- crossings_wbc$bin_mid[1]
wbc_upper_histogram <- crossings_wbc$bin_mid[2]
```
