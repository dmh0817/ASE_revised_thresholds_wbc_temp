...
# ================================================================
```{r}
best_temp <- results_temp$top10_youden %>%
  arrange(desc(youden)) %>%
  slice(1)

temp_lower_youden <- best_temp$lower
temp_upper_youden <- best_temp$upper
...
# ================================================================
```{r}
best_wbc <- results_wbc$top10_youden %>%
  arrange(desc(youden)) %>%
  slice(1)

wbc_lower_youden <- best_wbc$lower
wbc_upper_youden <- best_wbc$upper
```
